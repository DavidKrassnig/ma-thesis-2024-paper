...
\WarningFilter{xcolor}{Package option `hyperref' is obsolete and ignored}
%% Dokumentpakete
...
\usepackage[acronym,automake]{glossaries-extra}%Abkürzung- und Begriffverwaltung
    ...
    \input{matter/frontmatter/acronyms}
...
\usepackage{pgfplots} %Akademische Diagramme
    ...
    \definecolor{c125b85}{RGB}{18,91,133}%Wappen
    \definecolor{cd5a544}{RGB}{213,165,68}%Wappen
...
\input{config/paragraphtitle}
%Kartenbefehle
\definecolor{ce7e7e7}{RGB}{231,231,231}
\input{config/map_commands/drawbw}
\input{config/map_commands/drawbav}
\input{config/map_commands/drawberlin}
\input{config/map_commands/drawbrandenburg}
\input{config/map_commands/drawbremen}
\input{config/map_commands/drawgermany}
\input{config/map_commands/drawhamburg}
\input{config/map_commands/drawhessen}
\input{config/map_commands/drawmecklenburg}
\input{config/map_commands/drawniedersachsen}
\input{config/map_commands/drawnrw}
\input{config/map_commands/drawrheinland}
\input{config/map_commands/drawsaarland}
\input{config/map_commands/drawsachsen}
\input{config/map_commands/drawsachsenanhalt}
\input{config/map_commands/drawschleswig}
\input{config/map_commands/drawthuringen}
...
%% Hauptdokument %%
%\includeonly{appendices/appendice-part,appendices/richtlinienklassifikation,appendices/luh-repo-code} %Selektive Dokumentgenerierung
\begin{document}
    %% Vorderer Teil
    \frontmatter
        ...
        \include{matter/frontmatter/danksagung}
        \include{matter/frontmatter/content_list}  %Inhalts-, Tabellen- und Abbildungsverzeichnis
    %
    %% Hauptteil
    \mainmatter
        \include{content/einfuehrung}%\glsresetall
        \include{content/forschungsstand}%\glsresetall
        \include{content/fdm-policies}%\glsresetall
        \include{content/luh-repo-evaluation}%\glsresetall
        \include{content/schluss}%\glsunsetall
    %
    %% Hinterer Teil
    ...
    %% Appendix
    \appendix
    \include{appendices/appendice-part}
    \include{appendices/richtlinienklassifikation}
    \include{appendices/luh-repo-code}
