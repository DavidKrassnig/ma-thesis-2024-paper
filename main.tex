...
%% Hauptdokument %%
%\includeonly{content/luh-repo-evaluation} %Selektive Dokumentgenerierung
\begin{document}
    %% Vorderer Teil
    \frontmatter
    ...
    \mainmatter
        ...
        \include{content/forschungsstand}
        \include{content/fdm-policies}
        \include{content/luh-repo-evaluation}
