...
\begin{tikzpicture}
    ...
    \addplot[fill=colorblindC7] table [percentage series=never] {\datatable};
    \addplot[fill=colorblindC6] table [percentage series=rarely] {\datatable};
    \addplot[fill=colorblindC1] table [percentage series=often] {\datatable};

    \legend{\strut Keine, \strut \gls{gwp}-Richtlinie, \strut \gls{forschungsdaten}-Richtlinie}
    \end{axis}
\end{tikzpicture}
\vspace{-3.5mm}