...
\begin{table}[!htbp]
    ...
    \input{content/tables/stichprobe-klassifikation.tex}
...
\hspace{-7.5mm}%
    \begin{tikzpicture}
        \begin{axis}[
            ...
            symbolic x coords={Baden-Württemberg, Bayern, Berlin, Brandenburg, 
        ...
        \pgfplotstableread[col sep=comma]{content/plots/policy_klassifikation_allgemein_prozent.csv}\datatable
        \addplot+[ybar] table[x=Region,y=never]{\datatable};
        \addplot+[ybar] table[x=Region,y=rarely]{\datatable};
        \addplot+[ybar] table[x=Region,y=sometimes]{\datatable};
        \addplot+[ybar] table[x=Region,y=often]{\datatable};
